...
Token::Token(const Location& loc, Tag tok)
    : HasLocation(loc)
...
Token::Token(const Location& loc, Tag tag, const std::string& str)
    : HasLocation(loc)
    , symbol_(str)
    , tag_(tag)
{
...
thorin::HashMap<Token::Tag, const char*, Token::TagHash>  Token::tok2str_;
thorin::HashMap<Token::Tag, Symbol, Token::TagHash>       Token::tok2sym_;
thorin::HashMap<Symbol, Token::Tag>                        Token::keywords_;
thorin::HashMap<Symbol, Token::Tag>                        Token::sym2lit_;
thorin::HashMap<Symbol, Token::Tag>                        Token::sym2flit_;
